    ...
    if c.lower() == 'q':
        ...
        for l in i:
            if l == '':
                ...
                l1 = (l.replace('Nama : ', '').replace('Nim : ', '')
                       .replace('Tugas : ', '').replace('UTS : ', '')
                       .replace('UAS : ', '').replace('Akhir : ', ''))
                na, ni, tu, uts, uas, akhir = l1.strip().split('|')
                P('║ ' + na[:15].ljust(17, '.') + '║ ' + ni.ljust(17) +
                  '║ ' + tu.ljust(6) + '║ ' + uts.ljust(6) +
